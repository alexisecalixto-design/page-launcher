  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        {/* Desktop nav + WhatsApp grouped together */}
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 border border-accent-foreground/30 bg-transparent text-foreground px-5 py-2 rounded-full text-sm font-semibold hover:bg-gold hover:text-gold-foreground hover:border-gold transition-colors"
            style={{ color: scrolled ? undefined : "white", borderColor: scrolled ? undefined : "rgba(255,255,255,0.4)" }}
          >
